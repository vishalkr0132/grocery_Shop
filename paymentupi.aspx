<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="paymentupi.aspx.cs" Inherits="paymentupi" %>
								...
								<form action="#" method="post">
									...
									<!--<div class="checkbox checkbox-small">
                                     ...
                                     <a href="Googlepay.aspx"><h4 class="btn btn-primary">Google Pay</h4></a> &nbsp &nbsp &nbsp
                                      <a href="paymentupi.aspx"><h4 class="btn btn-primary">BHIM UPI</h4></a>&nbsp &nbsp &nbsp
                                      <a href="payment.aspx"><h4 class="btn btn-primary">Cash On Delivery</h4></a>
